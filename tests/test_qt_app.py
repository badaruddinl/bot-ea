...
class QtAppTests(unittest.TestCase):
    ...
    def test_qt_window_constructs(self) -> None:
        ...
        try:
            ...
            self.assertIs(window.dashboard_splitter.widget(1), window.logs_group)
            self.assertIs(window.dashboard_body_splitter.widget(0), window.trade_control_scroll)
            self.assertIs(window.trade_control_scroll.widget(), window.trade_control_panel)
            self.assertIs(window.dashboard_body_splitter.widget(1), window.snapshot_dashboard)
