...
class QtAppTests(unittest.TestCase):
    ...
    def test_qt_window_constructs(self) -> None:
        ...
        try:
            ...
            self.assertIs(window.dashboard_page.layout().itemAt(3).widget(), window.snapshot_dashboard)
            ...
            self.assertIs(window.logs_page.layout().itemAt(2).widget(), window.logs_group)
