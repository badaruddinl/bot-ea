...
| G14 | IN_PROGRESS | SHARED, GOLDI, GOLDM, CROSS_PROFILE | `evidence/G14-execution-lifecycle/` | Native execution guard parity, broker request lifecycle, ownership, management, and restart recovery are being implemented; REAL authority remains disabled. |
