...
| G18 | IN_PROGRESS | SHARED, GOLDI, GOLDM, CROSS_PROFILE | `evidence/G18-failure-restart-e2e/` | All dependency, broker, ownership, duplicate/collision, open-position, disconnect/reconnect, and single/dual-terminal process evidence passed. Only actual Windows/VM boot-cycle evidence is deferred; REAL authority remains disabled. |
