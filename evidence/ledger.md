...
| G08 | IN_PROGRESS | SHARED, GOLDI, GOLDM, CROSS_PROFILE | `evidence/G08-execution-validity/` | Immutable execution policy/plan and complete pre-send guards are under implementation. |
