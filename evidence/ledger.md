...
| G20 | IN_PROGRESS | SHARED, GOLDI, GOLDM, CROSS_PROFILE | `evidence/G20-fresh-vm-acceptance/` | Preparing password-backed AtStartup tasks and a scheduled cold-boot proof with no interactive Windows login. Temporary G18 ONLOGON launchers are not accepted. |
