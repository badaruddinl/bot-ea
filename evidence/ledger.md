...
| G04 | IN_PROGRESS | SHARED, GOLDI, GOLDM | `evidence/G04-pure-rule-extraction/` | Revised and Bear rules are being moved into one pure implementation used by legacy replay/live callers. |
