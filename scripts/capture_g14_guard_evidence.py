...
PROOFS: dict[str, ProofSpecification] = {
    ...
    "lifecycle_goldm": {
        "expert": "GoldEngineExecutionLifecycleGoldmHarness.ex5",
        "stem": "goldm-execution-lifecycle-tester",
        "required": (
            "G14_EXECUTION_LIFECYCLE passed=true initialized=true opened=true ",
            "discovered=true modified=true restarted=true closed=true",
            "positions_before=0 positions_after=0",
            "open_retcode=10009",
            "reject_mask=0 submit_reason=ORDER_SENT modify_retcode=10009 close_retcode=10009",
            "magic=26081912 order_authority=TESTER_ONLY reason=POSITION_CLOSED",
        ),
        "authority": "TESTER_ONLY",
        "profiles": ["GOLDM"],
        "balance": "final balance ",
    ...
    "lifecycle_goldi": {
        "expert": "GoldEngineExecutionLifecycleHarness.ex5",
        "stem": "goldi-execution-lifecycle-g15-tester",
        "required": (
            "G14_EXECUTION_LIFECYCLE passed=true initialized=true opened=true ",
            "discovered=true modified=true restarted=true closed=true",
            "positions_before=0 positions_after=0",
